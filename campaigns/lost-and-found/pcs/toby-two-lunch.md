...
| Beast Bond | 1 | 1 A | Touch | Yes | No | V,S,M | Link to a beast so you can communicate empathically. |
| Earth Tremor | 1 | 1 A | 10 ft. | No | No | V,S | Shake the ground and possibly knock creatures prone. |
| Ice Knife | 1 | 1 A | 60 ft. | No | No | S,M | Hurl a shard that explodes into cold damage in a small area. |
| Animal Friendship | 1 | 1 A | 30 ft. | No | No | V,S,M | Charm a beast into treating you as a friend. |
| Faerie Fire | 1 | 1 A | 60 ft. | Yes | No | V | Outline creatures in light and help allies hit them. |
| Fog Cloud | 1 | 1 A | 120 ft. | Yes | No | V,S | Create a heavily obscuring cloud. |
| Protection from Evil and Good | 1 | 1 A | Touch | Yes | No | V,S,M | Protect a creature from certain creature types. |
...
| Detect Magic | 1 | 1 A + 10m | Self | Yes | Yes | V,S | Sense magic nearby. |
| Healing Word | 1 | 1 BA | 60 ft. | No | No | V | Heal a creature at range. |
| Thunderwave | 1 | 1 A | Self/15 ft. Cube | No | No | V,S | Push creatures away with thunder. |
